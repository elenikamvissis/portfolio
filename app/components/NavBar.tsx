                ...
                <div className="flex items-center justify-between py-3 ">
                    <Link href="/">
                        <div className="flex flex-row items-center">
                            <Image src="/logo.jpeg" alt="Logo" width={50} height={50} className="rounded-full shadow-sm shadow-slate-500 mr-2" />
                            <div className="md:py-5 flex flex-row align-middle">
                                <h1 className="text-xl font-medium text-gray-900">Eleni Kamvissis</h1>
                            </div>
                        </div>
                    </Link>
